About google-cloud-core-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-cloud-core-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-core-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-cloud-core
# for installing globally
pixi global install google-cloud-core
```
...
It is possible to list all of the versions of `google-cloud-core` available on your platform:
...
```
pixi search google-cloud-core --channel conda-forge
```
